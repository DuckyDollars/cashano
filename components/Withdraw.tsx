...
const Withdraw = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isButtonEnabled || !userId) return;
    ...
    try {
      ...
      if (data.success) {
        ...
        const transactionData = {
          ...
          title: "Sent",
          photoUrl:
            "https://brown-just-donkey-162.mypinata.cloud/ipfs/QmP43PA88CS4sFrx13yv13gBtTJGka4NS9fuYWj4hVjvUN",
        };

        await dynamoDB
          .update({
            TableName: "invest",
            Key: { UserID: userId }, // Use dynamic userId
            UpdateExpression:
              "SET transactionHistory = list_append(if_not_exists(transactionHistory, :emptyList), :newTransaction)",
